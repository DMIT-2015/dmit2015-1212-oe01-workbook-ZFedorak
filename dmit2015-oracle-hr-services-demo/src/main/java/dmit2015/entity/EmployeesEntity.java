...
public class EmployeesEntity {
    ...
    @OneToOne
    private DepartmentsEntity departments_0;
    @OneToOne
    private EmployeesEntity employees;
    @OneToOne(mappedBy = "employees")
    private EmployeesEntity employees_0;
    ...
    public DepartmentsEntity getDepartments_0() {
        return departments_0;
    }

    public void setDepartments_0(DepartmentsEntity departments_0) {
        this.departments_0 = departments_0;
    }
    ...
    public EmployeesEntity getEmployees_0() {
        return employees_0;
    }

    public void setEmployees_0(EmployeesEntity employees_0) {
        this.employees_0 = employees_0;
    }
}
